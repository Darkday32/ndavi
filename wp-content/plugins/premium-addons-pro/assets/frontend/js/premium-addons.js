(function ($) {
    ...
    var PremiumInstaFeedHandler = function ($scope, $) {
        ...
        var template =
            '<div class="premium-insta-feed premium-insta-box"><div class="premium-insta-feed-inner"><div class="premium-insta-feed-wrap"><div class="premium-insta-img-wrap"><img src="{{image}}"/></div><div class="premium-insta-info-wrap"><div class="premium-insta-feed-interactions">' +
            settings.likes +
            settings.comments +
    ...
    var PremiumTabsHandler = function ($scope, $) {
        ...
        var $premiumTabsElem = $scope.find(".premium-tabs-container"),
            ...
            id = "#premium-tabs-" + settings.id,
            start = settings.start;

        new CBPFWTabs($premiumTabsElem, id, start);
