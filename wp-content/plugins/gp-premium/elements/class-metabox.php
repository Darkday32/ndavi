						...
						<td class="generate-element-row-content">
							...
							<div class="layout-radio-item">
								<label for="right-sidebar-layout" title="<?php esc_attr_e( 'Right Sidebar', 'gp-premium' );?>">
									<input type="radio" name="_generate_sidebar_layout" id="meta-generate-layout-one" <?php checked( get_post_meta( get_the_ID(), '_generate_sidebar_layout', true ), 'right-sidebar' ); ?> value="right-sidebar">
